#' The mymlnorm function. Makesa max lik function for two parameters
#'
#' @param x the sample getting tested
#' @param mu the mean of the sample
#' @param sig the standard deviation of the sample
#'
#' @return A graph showing the estimated maximum likliehood.
#' @export
#'
#' @examples
